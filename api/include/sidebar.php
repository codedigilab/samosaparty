        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li class="submenu-open">
                    ...
                    <ul>
                        <li>
                            <a href="index.php" class="subdrop active"><i
                                    data-feather="grid"></i><span>Dashboard</span></a>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><i data-feather="smartphone"></i><span>Store Data</span><span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="internet.php">Internet</a></li>
                                <li><a href="wifipass.php">Wifi Password</a></li>
                                <li><a href="storenumber.php">Store Number</a></li>
                                <li><a href="laptop.php">Laptop Details</a></li>
                                <li><a href="camera.php">Camera Details</a></li>

                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><i data-feather="smartphone"></i><span>Problem</span><span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="storeproblem.php">Store Problem</a></li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href="manage-stocks.php"><i data-feather="package"></i><span>Manage Stock</span></a>
                        </li>
